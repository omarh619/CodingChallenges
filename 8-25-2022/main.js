...
//P: (infected, discovered), Expect all discovered letters to be given in the correct order, Discovered letters will match the number of censored ones. Any character can be censored.
//R: replace * in infected string with the discovered letters
//E:
    ...
    function uncensor(infected, discovered){
        ...
        return infected
        //replace every * with the discovered letter in order
        // return the string
    }