...
//P: coffees, an array of times
//R: return time it takes for each to receive coffee
function barista(coffees) {
    ...
    // get the times
    coffees.reduce((prev, curr, i) => {
      let time;
  
      if (i === 0) time = prev + curr;
      else time = prev + cleaning + curr;
