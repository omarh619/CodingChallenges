...
//P: number, must be a number
//R: return either if sum is odd or even, return odd or even
function oddOrEven(n){
    ...
    // conditional, use remainder not equal 0 is either
    // number divide by 2 then reminder 2 for odd and even
