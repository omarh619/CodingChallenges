...
//P: (text), string wil be numbers and letters, return count of repeated characters in string
//R: return the count of repeated characters in string
//E:"abcde" -> 0 # no characters repeats more than once
/* "aabbcde" -> 2 # 'a' and 'b'
"aabBcde" -> 2 # 'a' occurs twice and 'b' twice (`b` and `B`) */

function duplicateCount(text){
    // make an array all lowercase and sorts the array 
