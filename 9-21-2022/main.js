...
//P: (moneyIn), create a change machine, change will be in string format
//R: return correct change 
//E: ("£1") =>"20p 20p 20p 20p 20p")

const changeMe = moneyIn => {
    switch (moneyIn) {
        // repeat amount of times needed for correct change
        // case and return
