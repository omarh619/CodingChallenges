...
//P: (distance), figure out how many folds of paper does it take to reach distance
//R: return folds needed for paper to reach distance, if distance is negative return null
//E: (.ooo2)=> 1

function foldPaper(distance){
    //create variables for paper and folds
    let paper = 0.0001
    let folds = 0;
    // conditional for when distance is < 0
    if(distance <= 0){
        return null
    ...
    // create a while loop for paper folds
    //return folds
    return folds
}
